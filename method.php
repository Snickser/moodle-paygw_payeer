...
$PAGE->set_url('/payment/gateway/payeer/method.php', $params);
$string = get_string('payment', 'paygw_payeer');
...
$templatedata->image = $OUTPUT->image_url('img', 'paygw_payeer');

echo $OUTPUT->render_from_template('paygw_payeer/method', $templatedata);
