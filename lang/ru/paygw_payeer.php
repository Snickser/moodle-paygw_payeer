...
$string['callback_help'] = 'Скопируйте эти строки и вставьте в настройках проекта в payeer. Отключите настройку "Мой проект на CMS".';
...
$string['gatewaydescription'] = 'payeer — надежный способ легко и удобно принимать оплату со всего мира в самых популярных криптовалютах.';
...
$string['pluginname'] = 'Платежи payeer';
$string['pluginname_desc'] = 'Плагин payeer позволяет получать платежи через payeer.';
